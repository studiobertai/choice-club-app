...
export default function Hero() {
  return (
    <div className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      {/* FONDO ANIMADO - Corrección de sintaxis */}
      ...
      <div className="relative z-20 text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a 
            href="#eventos" 
            className="px-8 py-4 w-full sm:w-auto bg-transparent border border-white/30 hover:border-white text-white rounded-full font-bold text-lg transition-all backdrop-blur-sm cursor-pointer flex justify-center"
          >
            Próxima Fecha
          </a>
